...
./compile.sh BOARD=orangepizero BRANCH=current BUILD_DESKTOP=no BUILD_MINIMAL=yes KERNEL_CONFIGURE=no RELEASE=focal DEST_LANG="pt_BR.UTF-8" SHARE_LOG=yes | tee build.log
